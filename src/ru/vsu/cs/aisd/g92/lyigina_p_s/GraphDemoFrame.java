...
import ru.vsu.cs.aisd.g92.lyigina_p_s.Graph;
import ru.vsu.cs.aisd.g92.lyigina_p_s.GraphAlgorithms;
import ru.vsu.cs.aisd.g92.lyigina_p_s.GraphUtils;
    ...
    public GraphDemoFrame() {
        ...
        buttonCreateGraph.addActionListener(e -> {
            try {
                ...
                Class clz = Class.forName("ru.vsu.cs.aisd.g92.lyigina_p_s." + className);
